 ...
 * review：快速選擇算法操作 1. 選擇一個樞紐元素， 通常是數組的第一個元素（left） 2.分區（把比樞紐元素小的都放到左邊，反之放右邊）3.
 * 遞歸：樞紐元素的位置可以用來判斷第k個最大or最小元素在左邊還是右邊，如果樞紐元素正好是k，就返回k；如果樞紐元素比k小，就在數組的右邊找；如果樞紐元素比k大，就在數組的左邊找
 * 
